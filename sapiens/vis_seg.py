...
def main():
    ...
    for file_id in file_ids:
        os.makedirs(os.path.join(args.output_root, file_id), exist_ok=True)
    ...
    for batch_idx, (file_id, batch_image_name, batch_orig_imgs, batch_imgs) in tqdm(
        ...
        args_list = [
            ...
            for i, r, file_id_name, img_name in zip(
    ...
    print(
        f"\033[92mTotal inference time: {total_time:.2f} seconds."
    )
